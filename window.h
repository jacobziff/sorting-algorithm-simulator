...
void updateWindow(sf::RenderWindow& window, Screen currentScreen, const std::vector<int>& nums, sf::Font& font, bool cursorOn = true, int cursor = -1, bool doneSorting = false);
